...
def main():
    ...
    parser.add_argument("--data-dir", type=str, default="/home/ray/preject/data/non_iid_MSCOCO_train_30_50/")
    ...
    # )
    train_loader, test_loader, _ = data.MSCOCO_image("ssl",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size,F="N")
    infer_train_loader, infer_test_loader, _ = data.MSCOCO_image("base",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size)
    ood_loader,_,_ = data.MSCOCO_image("base",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size, F = "OOD")
    ...
    if args.warmup:
        ...
        for epoch in range(wamrup_epochs):
            trainer(
            model, device, train_loader, criterion, optimizer, warmup_lr_scheduler, epoch, args
        )
